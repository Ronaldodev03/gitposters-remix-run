...
//esto es para ver si estoy logged, sino hace un redirect
export const loader = async ({ request }: LoaderFunctionArgs) => {
  const { headers, session } = await getSupabaseWithSessionAndHeaders({
    request,
  });
...
export default function Index() {
  return (
    <section className="w-full min-h-screen   flex flex-col">
      ...
      <div className="container //md:flex flex justify-center items-center px-4 md:px-6 flex-1">
